...
| ARQ-SIGNALS-R021 | Read-only transaction enforcement | TC-SIG-025, TC-SIG-036 | signals_safety_behavioral_test.go, signals_commit_test.go | COVERED | BEHAVIORAL + STRUCTURAL | Dedicated connection acquired before BeginTx. SET LOCAL for timeouts. Commit error checked and blocks downstream persistence. |
