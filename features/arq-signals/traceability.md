...
| R082 (Phase 3+) | Mode flag + arq_control_plane token + entitlement protocol | TC-SIG-081..N (planned) | PLANNED | BEHAVIORAL | Future work — see specification.md "Future implementation plan" table. |
